...
class Longitud:
    ...
    def conversion_pulgada(self):
        ...
        y = 25.40
        r = (self.x * y)
        print(f'{self.x} pulgadas son iguales a: {r:.2f} milimetros')
    ...
    def conversion_yarda(self):
        ...
        y = 0.9144
        r = (self.x * y)
        print(f'{self.x} yardas son iguales a: {r:.2f} metros')
    ...
    def conversion_milla(self):
        ...
        y = 1.6093 
        r = (self.x * y)
        print(f'{self.x} millas son iguales a: {r:.2f} kilometros')
    ...
    def conversion_pulgada2(self):
        ...
        y = 6.4516 
        r = (self.x * y)
        print(f'{self.x} pulgadas^2 son iguales a: {r:.2f} centimetros')
    ...
    def conversion_pie2(self):
        ...
        y = 0.09290 
        r = (self.x * y)
        print(f'{self.x} pie^2 son iguales a: {r:.2f} metros^2')
    ...
    def conversion_yarda2(self):
        ...
        y = 0.8361
        r = (self.x * y)
        print(f'{self.x} yarda^2 son iguales a: {r:.2f} metros^2')
    ...
    def conversion_acre(self):
        ...
        y = 0.4047 
        r = (self.x * y)
        print(f'{self.x} acres son iguales a: {r:.2f} hectareas')
    ...
    def conversion_milla2(self):
        ...
        y = 2.59 
        r = (self.x * y)
        print(f'{self.x} millas^2 son iguales a: {r:.2f} kilometros^2')
